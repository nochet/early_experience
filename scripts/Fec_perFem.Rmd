...
ffQ <- left_join(aj1,recs, by="camera_id")
...
subset(aj1,aj1$camera_id %in% recs$camera_id)
...
```{r}
# Masking file
mask <- read.table("~/MyGithub/early_experience/scripts/name_conversion.txt", header = FALSE,stringsAsFactors = FALSE)
# 
aj2 <- read.table(
  "~//MyGithub/early_experience/original/ee_temp_Values_Sheet_AJ.txt", 
  header = FALSE,stringsAsFactors = FALSE)
colnames(aj2) <- c("inum", "icount")

dd1 <- read.table(
  "~//MyGithub/early_experience/original/EE_counts_DD.txt", 
  header = FALSE,stringsAsFactors = FALSE)
colnames(dd1) <- c("inum", "icount")
```

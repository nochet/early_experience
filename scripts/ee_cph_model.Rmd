...
imod1.0 <- coxph(Surv(age, status) ~  larvalTreat + adultTreat + 
                   larvalTreat*adultTreat + sex + cageID, 
                 data = eelife)
summary(imod1.0) 
...
library(coxphw)
fit2<-coxphw(data=eelife, Surv(age,status) ~ larvalTreat + adultTreat + 
                   larvalTreat*adultTreat + strata(sex), template = "AHR" )
...
# Drop interaction
imod1.3 <- coxme(Surv(age, status) ~ larvalTreat + adultTreat + 
                    strata(sex) + (1| cageID), data = eelife)
summary(imod1.3)

anova(imod1.1,imod1.2,imod1.3,imod1.4,imod1.5,imod1.6)

...
```{r}
# Females
smod1.2.0 <- coxph(Surv(age, status) ~ larv_adult + 
                     larvalTreat*adultTreat + cageID, 
                   data = eelifeF)
...
summary(smod1.2.1) 
cox.zph(smod1.2.1) # NPH

smod1.2.2 <- coxph(Surv(age, status) ~ larvalTreat + 
                     strata(adultTreat) + larv_adult, 
                   data = eelifeF)
summary(smod1.2.2)
cox.zph(smod1.2.2) # NPH

anova(smod1.2.1, smod1.2.2)

aictab(list(smod1.2.1, smod1.2.2))
# smod1.2.1 is better


# Males
smod1.3.0 <- coxph(Surv(age, status) ~ larv_adult + 
                     larvalTreat*adultTreat + cageID, 
                   data = eelifeM)
summary(smod1.3.0) # No cage effects 
cox.zph(smod1.3.0) # NPH

smod1.3.1 <- coxph(Surv(age, status) ~ larvalTreat + strata(adultTreat) + 
                  larvalTreat*adultTreat, data = eelifeM)
summary(smod1.3.1) 
cox.zph(smod1.3.1) # NPH

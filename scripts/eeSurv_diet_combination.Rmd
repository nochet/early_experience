...
ggplot(eelifespan, aes(x = Diet, y = Mean, color = Diet)) +
  geom_dotplot(binaxis = "y", stackdir='center', dotsize = .85, position = position_dodge(width = .5)) +
  geom_errorbar(aes(ymin = Mean - SD, ymax = Mean + SD), width = 0.3, position = position_dodge(width = .5))
...
#With Jitterdodge
ggplot(eelifespan, aes(x = Diet, y = Mean, color = Diet)) +
  geom_dotplot(binaxis = "y", stackdir='center', dotsize = .85, position = position_jitterdodge(.1)) +
  geom_errorbar(aes(ymin = Mean - SD, ymax = Mean + SD), width = 0.2, position = position_jitterdodge(.1))

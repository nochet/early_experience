...
cph4 <- coxph(Surv(age, status) ~ cpd_var + (1 + cageID) +
...
Splitting at intervals  0.5 - 20: interaction still non-PH.
Model sexes separately
Proceed to stan_surv()
...
# Now, split data set and repeat model

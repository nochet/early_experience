---
title: "Evaluate stan time varying effects (tve) models"
...
#mod1 <- readRDS("../processed/bhaz_mod1.rds")
...
# Use points instead of lines and reduce opacity of all but one chain
